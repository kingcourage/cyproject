...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/public/dist/css/bootstrap.css">
<!-- 最新的 Bootstrap 核心 JavaScript 文件 -->
<script
	src="${pageContext.request.contextPath}/public/dist/js/bootstrap.min.js"></script>
...
<body class="light-gray-bg">
		...
		<div class="templatemo-content-widget white-bg">
			...
			<form action="${pageContext.request.contextPath}/admin/register"
				...
				<div class="row form-group">
					<div class="col-lg-3 col-md-3 form-group"></div>
					<div class="col-lg-6 col-md-6 form-group">
						<label for="inputNewPassword">密码</label> <input type="password"
							name="passowrd" class="form-control" id="inputNewPassword">
					</div>
					<div class="col-lg-3 col-md-3 form-group"></div>
				</div>
				<div class="row form-group">
					<div class="col-lg-3 col-md-3 form-group"></div>
					<div class="col-lg-6 col-md-6 form-group">
						<label for="inputConfirmNewPassword">确认密码</label> <input
				...
				<div class="row form-group">
					<div class="col-lg-3 col-md-3 form-group"></div>
					<div class="col-lg-6 col-md-6 form-group">
						<label for="inputEmail">手机号码</label> <input type="phone"
							class="form-control" name="phone" id="inputPhone" placeholder="">
					</div>
					<div class="col-lg-3 col-md-3 form-group"></div>
				</div>
              ...
              <div class="row form-group">
				...
				<div class="row form-group">
					...
					<div class="col-lg-6 col-md-6 form-group">
						<div>
							...
							<div class="templatemo-inline-block margin-bottom-5">
								<input type="radio" name="sex" id="r2" value="女"> <label
									for="r2" class="font-weight-400"><span></span>女</label>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-md-3 form-group"></div>
				...
				<div class="row form-group">
					...
					<div class="col-lg-6 form-group">
						...
						<textarea class="form-control" name="comment" id="inputNote"
							rows="3"></textarea>
					</div>
					<div class="col-lg-3 col-md-3 form-group"></div>
				</div>
				<div class="form-group text-right">
					...
					<button type="reset" class="templatemo-white-button"
						onclick="javascript:window.location.href='${pageContext.request.contextPath}/login.jsp'">返回</button>
				</div>
			</form>
		</div>
		<footer class="text-right">
			<p>
				Copyright &copy; 2084 kingcourage | Designed by <a
					href="http://www.templatemo.com" target="_parent">wcy</a>
			</p>
		</footer>
	</div>
	</div>
	...
	<!-- jQuery -->
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/public/js/bootstrap-filestyle.min.js"></script>
