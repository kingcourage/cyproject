...
<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
	...
	<div class="header-top">
		...
		<div class="col-md-4 world">
			...
			<c:if test="${CURRENT_USER != null}">
				<p class="log"><a href="${pageContext.request.contextPath}/user/shop/index"  >您好,${CURRENT_USER.username}</a></p>
				<p class="log"><a href="${pageContext.request.contextPath}/logout" >注销登陆</a></p>
			</c:if>		
