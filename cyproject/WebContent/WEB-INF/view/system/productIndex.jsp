...
<body>
	<table id="dg" title="商品列表" class="easyui-datagrid"
		...
		url="${pageContext.request.contextPath}/product/getAllProducts"
		...
		<thead>
			<tr>
				...
				<th field="stock" width="20">库存</th>
			</tr>
		</thead>
	</table>
	<div id="toolbar">
		<a href="#" class="easyui-linkbutton" iconCls="icon-edit" plain="true"
			onclick="editProduct()">编辑商品</a> <a href="#"
	...
	<div id="dlg" class="easyui-dialog"
		...
		<form id="fm" method="post">
			...
			<div class="fitem">
				<label>副标题:</label> <input name="subtitle"
			...
			<div class="fitem">
				...
				<input type="hidden" name="mainImage" class="easyui-validatebox">
			</div>
