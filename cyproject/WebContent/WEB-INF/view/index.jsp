			...
			<div class="templatemo-flex-row flex-content-row">
				<div class="templatemo-content-widget white-bg col-2">
					...
					<p>
						...
						friends about <a href="http://www.templatemo.com" target="_parent">templatemo.com</a>
						website. You may <a href="http://www.templatemo.com/contact"
							target="_parent">contact us</a> if you have anything to say.
					</p>
				...
				<div class="templatemo-content-widget white-bg col-1 text-center">
					...
					<img
						src="${pageContext.request.contextPath}/public/images/bicycle.jpg"
						alt="Bicycle" class="img-circle img-thumbnail">
				</div>
						...
						<div class="media">
							<div class="media-left">
								<a href="#"> <img class="media-object img-circle"
									src="${pageContext.request.contextPath}/public/images/sunset.jpg"
									alt="Sunset">
								</a>
							</div>
